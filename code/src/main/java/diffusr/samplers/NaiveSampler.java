...
import diffusr.structures.NaiveMatrix;
...
public class NaiveSampler implements Sampler {
    ...
    /**
     * Samples a dataset from the uniform distribution of datasets with the same
     * row and column margins as the original dataset using the DiFfuSR-N
     * method.
     *
