 ...
 */
/**
 * A class that helps compute the minimum p-values of the WY samples in
 * parallel.
 */
public class MinPvaluesTask implements Runnable {
    ...
    /**
     * The path to the file of frequent itemsets for which we want to find the
     * minimum p-value.
     */
