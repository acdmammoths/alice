...
import alice.structures.GmmtMatrix_;
...
public class GmmtSampler_ {
     ...
     */
    public SparseMatrix_ sample(SparseMatrix_ inMatrix, int numSwaps, long seed, Timer timer) {
        final long setupTimeStart = System.currentTimeMillis();
        final GmmtMatrix_ matrix = new GmmtMatrix_(inMatrix);
...
//        System.out.println("SETUP: " + setupTime);
 ...
 Algorithm 4 Metropolis-Hastings.
     ...
     * @return the sampled matrix
     */
    public SparseMatrix_ sample(SparseMatrix_ inMatrix, long matrixDegree, int numSwaps, long seed, Timer timer) {
        final long setupTimeStart = System.currentTimeMillis();
        final GmmtMatrix_ matrix = new GmmtMatrix_(inMatrix);
...
//        System.out.println("SETUP: " + setupTime);
     ...
     * @return the sampled matrix
     */
    public SparseMatrix_ sample(SparseMatrix_ inMatrix, 
            int numSwaps, 
            long seed, 
            Timer timer, 
