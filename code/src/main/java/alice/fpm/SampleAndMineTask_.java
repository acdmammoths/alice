 ...
 */
public class SampleAndMineTask_ implements Runnable {

    /**
     * The sampler used to sample matrices.
     */
    private final GmmtSampler_ sampler;
     ...
     */
    private final SparseMatrix_ matrix;
    ...
    public SampleAndMineTask_(
            GmmtSampler_ sampler,
            Transformer transformer,
            SparseMatrix_ matrix,
            long degree,
            int numSwaps,
            long seed,
            double minFreq,
