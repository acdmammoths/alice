...
public class Itemset {
     ...
     */
    private final IntArrayList items = new IntArrayList();
    ...
    /**
     * This methods makes a copy of this itemset but without items having a
     * support lower than minsup
     *
    ...
    public boolean containsAll(Itemset itemset2) {
        ...
        for (int item : itemset2.getItems()) {
