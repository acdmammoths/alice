...
public class SequentialPatterns {
    ...
    public final List<List<SequentialPattern>> levels = Lists.newArrayList();
     ...
     * @param showSequenceIdentifiers if true, sequence identifiers will be
     ...
     *
     * @param nbObject the number of sequences in the database where these
     * patterns were found.
     * @param showSequenceIdentifiers if true, sequence identifiers will be
     * output for each pattern
     * @return a string
    ...
    /**
     * Get a list of list of sequential patterns such that at position i, there
     * is a list of sequential patterns containing i items.
     *
     * @return
     */
